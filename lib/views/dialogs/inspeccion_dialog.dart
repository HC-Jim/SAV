...
/// Formulario de inspección (Mecánico), a pantalla completa. Devuelve el
/// cuerpo para el backend o null si se cancela.
Future<Map<String, dynamic>?> mostrarInspeccionDialog(BuildContext context) {
  return Navigator.of(context).push<Map<String, dynamic>>(
    MaterialPageRoute(
      fullscreenDialog: true,
      builder: (_) => const _InspeccionScreen(),
    ),
  );
}

class _InspeccionScreen extends StatefulWidget {
  const _InspeccionScreen();
  @override
  State<_InspeccionScreen> createState() => _InspeccionScreenState();
}

class _InspeccionScreenState extends State<_InspeccionScreen> {
